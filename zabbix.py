...
class ZabbixInventory(object):
    ...
    def get_list(self, api):
        ...
        hosts_data = api.host.get(monitored_hosts=1, output='extend', selectGroups='extend', selectInterfaces=['useip', 'ip', 'dns'])
        data = {'_meta': {'hostvars': {}}}
    ...
    def __init__(self):
        ...
        if self.zabbix_server and self.zabbix_username:
            try:
                api = ZabbixAPI(url=self.zabbix_server, user=self.zabbix_username, password=self.zabbix_password)
